...
export default async function HomePage({ searchParams }: HomePageProps) {
  ...
  return (
    <div className="space-y-8">
      <section className="relative overflow-hidden rounded-[2rem] bg-[radial-gradient(circle_at_8%_20%,rgba(224,255,236,0.72),transparent_22%),radial-gradient(circle_at_92%_5%,rgba(255,213,190,0.68),transparent_26%),linear-gradient(180deg,rgba(255,251,244,0.92)_0%,rgba(250,246,238,0.82)_100%)] px-1 py-10 dark:bg-[radial-gradient(circle_at_8%_20%,rgba(0,105,72,0.22),transparent_24%),radial-gradient(circle_at_94%_8%,rgba(122,43,15,0.35),transparent_28%),linear-gradient(180deg,rgba(2,2,2,1)_0%,rgba(0,0,0,0.92)_100%)] md:py-16">
        <div className="relative grid gap-10 lg:grid-cols-[minmax(0,1fr)_370px] lg:items-center">
          <div className="space-y-7">
            ...
            <div className="space-y-4">
              <h1 className="font-heading max-w-5xl text-5xl font-black leading-[0.98] tracking-[-0.08em] text-foreground md:text-7xl lg:text-8xl">
      ...
      <section className="rounded-[1.75rem] bg-[#050505] bg-[linear-gradient(rgba(255,255,255,0.045)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.045)_1px,transparent_1px)] bg-[size:34px_34px] px-6 py-10 text-white shadow-[0_28px_80px_rgba(0,0,0,0.18)] dark:bg-[#f8f5ef] dark:bg-[linear-gradient(rgba(0,0,0,0.045)_1px,transparent_1px),linear-gradient(90deg,rgba(0,0,0,0.045)_1px,transparent_1px)] dark:text-black md:px-10 md:py-12">
